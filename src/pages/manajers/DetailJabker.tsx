  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" onClick={() => navigate("/manajers/dashboard")}>
          ...
          <CardContent>
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <Button variant="outline" size="sm" onClick={() => navigate("/manajers/assign-praktisi")}>
        ...
        <div className="lg:col-span-3 space-y-4">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <Button variant="default" className="w-full" onClick={() => navigate("/manajers/assign-praktisi")}>
                <UserPlus className="w-4 h-4 mr-2" />
                Assign Praktisi
              </Button>
              <div className="border-t border-slate-200 dark:border-slate-700 pt-3">
                <p className="text-xs font-medium text-slate-500 mb-2">Dokumen Jabker</p>
                <Button variant="outline" className="w-full mb-2" onClick={() => navigate(`/manajers/mapa-ttd/mapa01/${id}`)}>
                  <FileSignature className="w-4 h-4 mr-2" />
                  MAPA 01
                </Button>
                <Button variant="outline" className="w-full" onClick={() => navigate(`/manajers/mapa-ttd/mapa02/${id}`)}>
                  <FileSignature className="w-4 h-4 mr-2" />
                  MAPA 02
                </Button>
              </div>
              <Button variant="outline" className="w-full" onClick={() => navigate("/manajers/dashboard")}>
