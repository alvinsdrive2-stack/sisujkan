    ...
    return (
      <div style={{ background: '#fff', border: '1px solid #e2e8f0', borderRadius: '8px', padding: '24px', marginTop: '24px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', gap: '12px', flexWrap: 'wrap' }}>
          {jenis === "mapa01" ? (
            <>
              <Button variant="outline" onClick={() => navigate(`/manajers/detail-jabker/${jabkerId}`)}>
                <ArrowLeft style={{ width: '16px', height: '16px', marginRight: '8px' }} />
                Kembali ke Detail Jabker
              </Button>
              <Button onClick={() => navigate(`/manajers/mapa-ttd/mapa02/${jabkerId}`)}>
                Lanjut ke MAPA 02
              </Button>
            </>
          ) : (
            <>
              <Button variant="outline" onClick={() => navigate(`/manajers/mapa-ttd/mapa01/${jabkerId}`)}>
                <ArrowLeft style={{ width: '16px', height: '16px', marginRight: '8px' }} />
                Kembali ke MAPA 01
              </Button>
              <Button variant="default" onClick={() => navigate(`/manajers/detail-jabker/${jabkerId}`)}>
                Kembali ke Detail Jabker
              </Button>
            </>
          )}
