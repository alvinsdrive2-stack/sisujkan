            ...
            {loading ? (
              ...
              <div className="space-y-3">
                {praktisiList.map((p, idx) => (
                  <div
                    key={p.id}
                    className="p-4 border border-slate-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-800 transition-all hover:shadow-md hover:border-primary/30"
                  >
