  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" onClick={() => navigate("/manager-mutu/dashboard")}>
          ...
          <CardContent>
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <Button variant="outline" size="sm" onClick={() => navigate("/manager-mutu/assign-praktisi")}>
              ...
              <div className="space-y-3">
                {praktisiList.map((p, idx) => (
                  <div
                    key={p.id}
                    onClick={() => navigate(`/praktisi/kerja/${p.id}`, { state: { fromJabker: id } })}
        ...
        <div className="lg:col-span-3 space-y-4">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <Button variant="default" className="w-full" onClick={() => navigate("/manager-mutu/assign-praktisi")}>
                <UserPlus className="w-4 h-4 mr-2" />
                Assign Praktisi
              </Button>
              <div className="border-t border-slate-200 dark:border-slate-700 pt-3">
                <p className="text-xs font-medium text-slate-500 mb-2">Dokumen Jabker</p>
                <Button variant="outline" className="w-full mb-2" onClick={() => navigate(`/manager-mutu/mapa-ttd/mapa01/${id}`)}>
                  <FileSignature className="w-4 h-4 mr-2" />
                  MAPA 01
                </Button>
                <Button variant="outline" className="w-full" onClick={() => navigate(`/manager-mutu/mapa-ttd/mapa02/${id}`)}>
                  <FileSignature className="w-4 h-4 mr-2" />
                  MAPA 02
                </Button>
              </div>
              <Button variant="outline" className="w-full" onClick={() => navigate("/manager-mutu/dashboard")}>
